...
void main() {
  group('XSSProtection Tests', () {
    ...
    test('Safe user input unchanged', () {
      ...
      print('✅ Test 7 Passed — Safe input unchanged');
    });
